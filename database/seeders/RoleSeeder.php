...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Clientele
        Permission::create(['name' => 'view clientele','group'=>'customer','permission'=>'View All', 'description' => 'View a customer'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'send payment remainders to customers','group'=>'customer','permission'=>'disburse funds', 'description' => 'Send payment remainders to customers'])->syncRoles([$role1]);

        // Operation Module
        Permission::create(['name' => 'view operations','group'=>'operations','permission'=>'View All', 'description' => 'View Employees'])->syncRoles([$role1]);

        // Employees
        Permission::create(['name' => 'view employees','group'=>'employee','permission'=>'View All', 'description' => 'View Employees'])->syncRoles([$role1]);
        ...
        // Reports
        Permission::create(['name' => 'view reports','group'=>'reports','permission'=>'View All', 'description' => 'View Reports Module'])->syncRoles([$role1]);
        ...
        // Loan Statuses
        Permission::create(['name' => 'processes loans','group'=>'loan_status','permission'=>'processes loans', 'description' => 'View Reports Module'])->syncRoles([$role1]);
        Permission::create(['name' => 'approve a loan','group'=>'loan_status','permission'=>'approve', 'description' => 'View Loan Reports'])->syncRoles([$role1]);
        Permission::create(['name' => 'decline a loan','group'=>'loan_status','permission'=>'decline', 'description' => 'View Loan Reports'])->syncRoles([$role1]);
        Permission::create(['name' => 'default a loan','group'=>'loan_status','permission'=>'default', 'description' => 'View Loan Reports'])->syncRoles([$role1]);
        Permission::create(['name' => 'not taken up loan','group'=>'loan_status','permission'=>'not taken up loan', 'description' => 'View Loan Reports'])->syncRoles([$role1]);
        ...
        // Repayments
        Permission::create(['name' => 'view repayments','group'=>'repayments','permission'=>'View All', 'description' => 'view repayments module'])->syncRoles([$role1]);
        Permission::create(['name' => 'view pending repayments','group'=>'repayments','permission'=>'View All Pending', 'description' => 'view repayments pending'])->syncRoles([$role1]);
        Permission::create(['name' => 'view missed repayments','group'=>'repayments','permission'=>'View All Missed', 'description' => 'view repayments missed'])->syncRoles([$role1]);
        Permission::create(['name' => 'view past maturity','group'=>'repayments','permission'=>'View All Past Maturity', 'description' => 'view past maturity date loans'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'view company financial statistics','group'=>'dashboard','permission'=>'Company Financial Stats', 'description' => 'View company financial statistics'])->syncRoles([$role1]);
        Permission::create(['name' => 'help-desk and support','group'=>'dashboard','permission'=>'Help-desk Shortcut', 'description' => 'Help-desk and support'])->syncRoles([$role1]);
        ...
        Permission::create(['name' => 'company overview dashboard','group'=>'dashboard','permission'=>'Company Stats', 'description' => 'View company overview dashboard'])->syncRoles([$role1]);
        ...
        // Loans Page --Done
        Permission::create(['name' => 'view loans','group'=>'loan','permission'=>'View All All', 'description' => 'View all loans'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name' => 'view pending','group'=>'loan','permission'=>'View All Pending', 'description' => 'View pending loan requests'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name' => 'view closed','group'=>'loan','permission'=>'View All Closed Loans', 'description' => 'View closed loan requests'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name' => 'disburse funds','group'=>'transaction','permission'=>'disburse funds', 'description' => 'Transfer funds to customers'])->syncRoles([$role1]);
        Permission::create(['name' => 'make payments','group'=>'transaction','permission'=>'make payments', 'description' => 'Make payments to repay loans'])->syncRoles([$role2]);
        Permission::create(['name' => 'withdraw funds','group'=>'transaction','permission'=>'withdraw funds', 'description' => 'Withdraw loan funds'])->syncRoles([$role2]);
