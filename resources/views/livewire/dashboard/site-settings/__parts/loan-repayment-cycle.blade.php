...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Repayment Cycles</span>
            <span class="text-muted mt-1 fw-semibold fs-7">Over repayment cycle</span>
        </h3>
        <div class="card-toolbar">
            <a href="{{ route('system-create', ['page' => 'loan-repayment-cycle']) }}" class="btn btn-sm btn-light-primary">
    ...
    <div class="card-body py-3">
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle gs-0 gy-4">
                ...
                <!--begin::Table body-->
                <tbody>
                    @forelse ($repayment_cycles as $item)
                    <tr>
                        <td>
                        ...
                        <td class="text-end">
                            <a title="Delete" wire:click="deleteRepaymentCycle({{ $item->id }})" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                    <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5"/>
                                </svg>
                            </a>
                            <a title="Edit" href="{{ route('system-edit', ['page' => 'loan-repayment-cycle', 'item_id' => $item->id]) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
