...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Disbursement Methods</span>
            <span class="text-muted mt-1 fw-semibold fs-7">Over payment methods</span>
        </h3>
        <div class="card-toolbar">
            <a href="{{ route('system-create', ['page' => 'loan-disbursements']) }}" class="btn btn-sm btn-light-primary">
