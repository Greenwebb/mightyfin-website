...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <a href="{{ route('item-settings', ['confg' => 'loan','settings' => 'loan-types']) }}" class="flex py-4 px-9">
        ...
        <span>
            Return Back to Loan Disbursement List
        </span>
    </a>
    <!--begin::Post-->
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <!--begin::Container-->
        <form wire:submit.prevent="create_disbursement" id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold text-info m-0">Disbursment:</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
