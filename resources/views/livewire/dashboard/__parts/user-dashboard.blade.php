          ...
          <div class="row">
            ...
            <div class="button-container mb-4">
              ...
              <a class="text-center" href="{{ route('payment.gate', ['view'=>'deposit']) }}">
                <span class="btn btn-default">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-wallet" viewBox="0 0 16 16">
              ...
              <a class="text-center" href="{{ route('profile.show', ['view'=>'kyc']) }}">
                <span class="btn btn-default">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-lightning-charge-fill" viewBox="0 0 16 16">
          ...
          <div class="row">
            ...
            <div class="mb-4 justify-content-between" style="display: flex; gap:1%;">
              <div class="notify-bell">
                <a href="{{ route('payment.gate', ['view'=>'deposit']) }}" class="btn" style="background: #662d91">
              ...
              <div class="notify-bell">
                <a href="{{ route('payment.gate', ['view'=>'deposit']) }}" class="btn text-primary" style="background: #662d912f"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-safe" viewBox="0 0 16 16">
