<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <!--begin::Navbar-->
            <div style="margin-top: -4%; background-image: url( {{ asset( 'public/mfs/admin/assets/media/product/loan_header.webp') }}); width: 109%;
            left: -5%;" class="card mb-6">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="apps/file-manager/files.html"
                                ...
                                <div class="symbol symbol-75px mb-5">
                                    <img src="assets/media/svg/files/folder-document.svg" class="theme-light-show"
                                        alt="" />
                                    <img src="assets/media/svg/files/folder-document-dark.svg" class="theme-dark-show"
                                        alt="" />
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="apps/file-manager/files.html"
                                ...
                                <!--begin::Image-->
                                <div class="symbol symbol-60px mb-5">
                                    <img src="assets/media/svg/files/doc.svg" class="theme-light-show"
                                        alt="" />
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="apps/file-manager/files.html"
                                ...
                                <!--begin::Image-->
                                <div class="symbol symbol-60px mb-5">
                                    <img src="assets/media/svg/files/css.svg" class="theme-light-show"
                                        alt="" />
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="apps/file-manager/files.html"
                                ...
                                <!--begin::Image-->
                                <div class="symbol symbol-60px mb-5">
                                    <img src="assets/media/svg/files/ai.svg" class="theme-light-show"
                                        alt="" />
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="apps/file-manager/files.html"
                                ...
                                <!--begin::Image-->
                                <div class="symbol symbol-60px mb-5">
                                    <img src="assets/media/svg/files/sql.svg" class="theme-light-show"
                                        alt="" />
                                                        ...
                                                        <label
                                                            ...
                                                            <span class="ms-5">
                                                                ...
                                                                <span class="fw-semibold fs-7 text-gray-600">Withdraw
                                                                    money to your bank account per transaction under
                                                                    $50,000 budget</span>
                                                            </span>
                                                            <!--end::Info-->
                                                        </label>
