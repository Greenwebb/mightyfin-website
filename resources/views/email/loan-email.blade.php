            ...
            <tr>
              <td style="padding:6%;background-color:#ffffff;">
                ...
                <div style="width: 100%; text-align: center; display: flex; align-items: center; justify-content: center;">
                    <a style="color: #fff; padding:5%;font-size:18px" target="_blank" href="https://mightyfinance.co.zm/dashboard" class="-btn -bg -txt">
            ...
            <tr>
              <td style="padding:30px;text-align:center;font-size: 0.75em;background-color:rgb(59, 5, 55) 17, 80);color:#384049;border: 1em solid #fff;">
                <p style="margin:0 0 0.75em 0;line-height: 0;">
                  ...
                  <!--      Facebook logo            -->
                  <a href="{{App\Models\ContactSetting::fb()}}" style="display:block;text-decoration:none;margin: 0 5px;">
                  ...
                  <!--     Instagram logo               -->
                  <a href="{{App\Models\ContactSetting::instagram()}}" style="display:block;text-decoration:none;margin: 0 5px;">
